...
import org.hbrs.se.ws20.uebung3.ContainerException.ExceptionType;
 ...
 * 
 * c/o Sascha Alda, H-BRS, 2017
 * 
 */

public class Container {
	
	// Der aktuelle List-Type, initial auf ARRAY gesetzt (Instanzvariable)
	...
	public boolean equals(Object obj) {
		return (this.getAnzahl() == ( (Container)  obj).getAnzahl() ) ;
	}
	...
	public void addMember ( Member r ) throws ContainerException {
		...
		if (!(r instanceof Info)) {
			ContainerException ex = new ContainerException( ExceptionType.InfoCastException );
			ex.addID ( r.getID() );
			throw ex;
		}
		...
		if ( contains(r) == true ) {
			...
			ContainerException ex = new ContainerException( ExceptionType.DuplicateMember );
			ex.addID ( r.getID() );
			throw ex;
		}
		liste.add(r);	
